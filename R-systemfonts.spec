...
Version  : 0.2.2
Release  : 6
URL      : https://cran.r-project.org/src/contrib/systemfonts_0.2.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/systemfonts_0.2.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589487535
