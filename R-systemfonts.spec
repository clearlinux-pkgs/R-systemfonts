...
Version  : 1.0.5
Release  : 36
URL      : https://cran.r-project.org/src/contrib/systemfonts_1.0.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/systemfonts_1.0.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696896522
